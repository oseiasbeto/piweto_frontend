<template>
    <div
        class="bg-white lg:hidden flex fixed z-[777] left-0 bottom-0 w-full overflow-hidden flex-col-reverse rounded-t-[8px] shadow-[0px_-9px_19px_-6px_rgba(0,0,0,0.2)] ">
    ...
    <!--start backdrop-->
    <div class="fixed inset-0 w-full pointer-events-none h-full z-[555] bg-[rgba(25,31,40,0.6)] transition-opacity duration-100 ease-in-out opacity-0 animate-fade-in"
