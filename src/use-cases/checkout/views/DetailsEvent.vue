    ...
    <div class="mb-10">
        <div v-if="!loadingEvent">
            <section>
                <!--start header-->
                <div>
                    <div class="flex z-50 justify-center w-full min-w-[320px] bg-white relative h-[180px] max-h-[280px] min-h-[180px] lg:h-[64vh] lg:max-h-[336px] lg:min-h-[336px] bg-[position:50%_50%] bg-[size:120%] before:absolute before:w-full before:h-full before:backdrop-blur-[24px] before:bg-[rgba(0,0,0,0.7)] before:content-['']"
                        :class="`bg-[url('https://images.sympla.com.br/67eef4dfd0a9c-lg.png')]`">
                        ...
                        <Container>
                            <div class="flex h-full w-full relative items-center lg:px-8">
                                <section class="hidden lg:block min-w-[320px]">
                                    <div class="pr-8">
                                        <h1
                                            ...
                                            Hamburgada do Bem - São José dos Campos - 526</h1>
                                ...
                                <section
                                    class="relative lg:mb-3.5 flex items-end justify-center h-full w-full max-w-[540px] max-h-[280px] mx-auto lg:rounded-xl bg-[url('https://images.sympla.com.br/67eef4dfd0a9c-lg.png')] bg-center bg-cover bg-no-repeat shadow-[0_20px_36px_0_rgba(25,31,40,0.2)]">
                                    <button @click="copyToClipboard('https://piweto.it.ao/' + route.fullPath)"
                                        class="-mb-[21px] bg-white text-[rgb(0,151,255)] rounded-full outline-none border-transparent border font-semibold font-sans text-sm leading-4 inline-flex items-center justify-center min-w-fit w-max cursor-pointer transition-[0.2s] ease-in no-underline px-4 py-2 flex-row uppercase">
                    ...
                    <div class="lg:mt-5">
                        <div class="flex flex-col lg:flex-row">
                            <div class="w-full lg:w-2/3">
                                <div class="bg-white lg:bg-transparent pt-8 lg:pt-4 px-4">
                                    <h3 style="letter-spacing: 0.2px;"
                                        class="text-[#191f28] mb-4 font-bold text-[28px] lg:text-3xl">{{
                                            event.name
                                        }}</h3>
                                        ...
                                        <div v-if="!loadingBatches">
                                            <div>
                                                <ul v-if="batches.data.length">
                                                    <li class="border-b py-4 px-4 text-[13px] text-[#50525f] border-[#dee2e6]"
                                ...
                                <div class="px-4 mt-7 hidden lg:block mb-4">
                                    <hr />
                                </div>
                                <div class="px-4 mb-5">
                                    <div class="mb-3">
                                            ...
                                            <div class="p-4">
                                                <div v-if="!isEventOver && amount > 0"
                                                    ...
                                                    <div class="flex items-center gap-1">
                                                        ...
                                                        <p class="text-lg font-bold">{{ formatAmount(amount) }}</p>
                                                    </div>
                                                </div>
