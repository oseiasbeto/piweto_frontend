    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded-md shadow-md border-t-4 border-blue-500">
            ...
            <div class="flex items-center gap-2">
                ...
                <p class="text-base font-medium" :class="statusTxtColor(event.status)">{{ generateStatusLegend(event.status) }}</p>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-md shadow-md border-t-4 border-teal-500">
            ...
            <h1 class="text-lg font-semibold text-teal-500">{{ formatCount(event.tickets_available_count -
                event.tickets_purchased_count) }}</h1>
        </div>
